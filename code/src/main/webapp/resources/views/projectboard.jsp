					...
					<div class="panel-body">
						<table ng-table="pc.tableParams" class="table table-bordered"
							...
							<tr ng-repeat="project in $data">
								...
								<td title="'Project State'" filter="{ state: 'text'}"
									sortable="'state'">{{project.state.value}}</td>
								<td title="'Action'">
									<button ng-if="pc.checkOwner(project)"
										class="btn btn-sm btn-primary"
										ng-click="pc.addMember(project)">Add Members</button>
									<button class="btn btn-sm btn-warning"
										ng-click="pc.openProjectHome(project)">View</button>
								</td>
							</tr>
						</table>
					</div>
